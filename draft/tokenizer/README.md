...
| 04 | 硬关键字与内建类型 Token | 已确认，`from`、`let`、访问修饰符、`static` 与 `final` 均为硬关键字；`constructor`、`destructor` 与 `operator` 为普通 Identifier | [`04-keywords-and-builtin-type-tokens.md`](./04-keywords-and-builtin-type-tokens.md) |
