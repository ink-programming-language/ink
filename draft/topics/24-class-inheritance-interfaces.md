...
> 状态：已确认，2026-08-04 确认 `virtual func f();` 抽象语义；2026-08-05 确认 `static func`、尾随 `const`、类与虚函数的 `final`、统一继承类型列表、显式字段和类/接口成员区域；议题 25—31、35、54—58 与 Parser 议题 10、31—33 补充
> 确认日期：2026-08-01
