...
| 03 | 析构、RAII 与 `defer` | 已确认，析构声明改为 `func ~ClassName()`；议题 27、32、34、42、48、51、53、54 修订；Parser 议题 09、18、25、26 确认 block、完整表达式、循环跳转与 `defer` 语法边界 | [`topics/03-raii-destructor-defer.md`](./topics/03-raii-destructor-defer.md) |
...
| 06 | 构造函数、隐式构造与字面量初始化 | 已确认，构造声明改为 `func ClassName(...)`；议题 34、54、72 修订，Parser 议题 30 确认构造调用 CST | [`topics/06-constructors-implicit-initialization.md`](./topics/06-constructors-implicit-initialization.md) |
...
| 16 | 内建属性与函数装饰器 | 已确认，议题 19、34、35、58、59、65 与 Parser 议题 29 补充 | [`topics/16-attributes-function-decorators.md`](./topics/16-attributes-function-decorators.md) |
...
| 24 | `class`、单继承与多接口 | 已确认，`virtual func f();` 表示抽象虚函数；议题 25—31、35、54—58 补充 | [`topics/24-class-inheritance-interfaces.md`](./topics/24-class-inheritance-interfaces.md) |
...
| 30 | 接口继承、重新抽象与接口转换 | 已确认，议题 31、35、56、60 补充 | [`topics/30-interface-inheritance.md`](./topics/30-interface-inheritance.md) |
| 31 | 安全下转型与动态接口转换 | 已确认，议题 32—34 补充 | [`topics/31-safe-dynamic-cast.md`](./topics/31-safe-dynamic-cast.md) |
| 32 | 枚举、判别联合与通用 niche 优化 | 已确认，议题 33、34、61 补充；Parser 议题 23、24 完成模式与 `match` 语法 | [`topics/32-enums-tagged-unions.md`](./topics/32-enums-tagged-unions.md) |
...
| 54 | 异步成员函数的 `this` 是非拥有原始指针 | 已确认，议题 55—57 补充异步虚函数、接口与反射 | [`topics/54-async-member-this-pointer.md`](./topics/54-async-member-this-pointer.md) |
...
| 58 | 异步函数装饰器包围任务执行体 | 已确认，议题 24、59 补充；Parser 议题 27 同步抛出语法 | [`topics/58-async-decorators-wrap-task-body.md`](./topics/58-async-decorators-wrap-task-body.md) |
...
| 62 | 编译期参数包是普通编译期序列 | 已确认，议题 64、66、68—71 补充绑定、反射、运行时包、元组与重载；Parser 议题 29 统一列表展开 | [`topics/62-comptime-parameter-packs.md`](./topics/62-comptime-parameter-packs.md) |
...
| 65 | 普通参数与编译期参数统一使用默认实参 | 已确认，议题 70 补充默认实参与重载候选关系；Parser 议题 29 确认函数类型语法 | [`topics/65-unified-default-arguments.md`](./topics/65-unified-default-arguments.md) |
...
| 68 | 运行时参数包与编译期类型包一一对应 | 已确认，议题 69、70 补充元组与闭合重载；Parser 议题 29 确认列表展开 | [`topics/68-runtime-parameter-packs.md`](./topics/68-runtime-parameter-packs.md) |
