...
| 26 | vptr、vtable 与接口胖引用 ABI | 已确认，议题 27—31、35、55、56 补充 | [`topics/26-vtable-interface-abi.md`](./topics/26-vtable-interface-abi.md) |
...
| 32 | 枚举、判别联合与通用 niche 优化 | 已确认，议题 33、34、61 补充 | [`topics/32-enums-tagged-unions.md`](./topics/32-enums-tagged-unions.md) |
| 33 | 枚举模式绑定、`if let` 与 `match` 表达式 | 已确认，议题 69 补充元组位置模式 | [`topics/33-pattern-binding-and-match.md`](./topics/33-pattern-binding-and-match.md) |
| 34 | 未检查异常、展开与 `[nothrow]` | 已确认，议题 35—48、52、58 补充 | [`topics/34-unchecked-exceptions-nothrow.md`](./topics/34-unchecked-exceptions-nothrow.md) |
...
| 45 | 并发组合等待 `all` | 已确认，议题 46—48、50、52、53、62、68、69 补充；动态任务集合属于库 | [`topics/45-concurrent-await-all.md`](./topics/45-concurrent-await-all.md) |
...
| 55 | 异步虚函数在任务创建时完成动态分派 | 已确认，议题 56—58、60 补充异步接口、反射、装饰器与结果不变型 | [`topics/55-async-virtual-dispatch-at-task-creation.md`](./topics/55-async-virtual-dispatch-at-task-creation.md) |
