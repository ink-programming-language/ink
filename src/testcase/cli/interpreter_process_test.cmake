...
string(FIND "${InvalidError}" "${InvalidInput}:1:" InvalidLocationOffset)
if(InvalidDiagnosticOffset EQUAL -1 OR InvalidLocationOffset EQUAL -1)
  message(FATAL_ERROR "invalid IR diagnostic did not include the source path and line on stderr: ${InvalidError}")
endif()
