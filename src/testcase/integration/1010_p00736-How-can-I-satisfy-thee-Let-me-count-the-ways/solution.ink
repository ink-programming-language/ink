...
var bcnt: dynamic = cpp_expression("#include <bits/std");

var INF: dynamic = cpp_expression("#include");

var n: dynamic = cpp_uninitialized();

var s: dynamic = cpp_array(111);

var sav: dynamic = cpp_array(111);
...
func repl(argument_0: dynamic, argument_1: dynamic, argument_2: dynamic) -> dynamic
{
      if ((s[i] == cpp_char("(")))
      {
        level += 1;
