...
namespace ink::execution
{
  namespace
  {
    ...
    void addMemoryFailure(ExecutionContext &Context, std::vector<core::Diagnostic> &Diagnostics, RuntimeMemoryStatus Status, std::string_view Operation, const std::string &FunctionName, std::uint64_t Index, std::uint64_t RegionLength, std::uint64_t AccessSize = 0)
    {
      switch (Status)
      {
